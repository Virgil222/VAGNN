...
class BPRLoss:
    ...
    def stageOne(self, users, posItem, negItem,posAuthor,negAuthor,users2, posAuthor2, negAuthor2):
        loss, reg_loss = self.model.bpr_loss(users, posItem, negItem,posAuthor, negAuthor,users2, posAuthor2, negAuthor2)
